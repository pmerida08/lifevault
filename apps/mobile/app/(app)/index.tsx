...
function UploadModal({
  ...
  async function submit() {
    ...
    try {
      ...
      // 4. Enviar URL + metadata al webhook de n8n
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0,0,0,0.45)' }}>
        <View style={{
          ...
          {/* Category selector */}
          <Text style={{ fontSize: 14, fontWeight: '700', color: t.textMuted, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 }}>
            Categoría
          </Text>
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginBottom: 28 }}>
            {cats.map((cat) => {
              ...
              return (
                ...
                >
                  <Text style={{ fontSize: 14, fontWeight: active ? '700' : '500', color: active ? '#fff' : t.textMuted }}>
                    {CAT_LABELS[cat]}
                  </Text>
                </TouchableOpacity>
              );
          ...
          <TouchableOpacity
            ...
            disabled={uploading}
            style={{
              backgroundColor: uploading ? t.primaryContainer : t.primary,
          ...
          >
            ...
            <Text style={{ fontSize: 17, fontWeight: '700', color: uploading ? t.primary : '#fff' }}>
...
export default function VaultScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: t.background }}>
      ...
      >
        {documents.map((doc) => (
          <DocCard key={doc.document_id} doc={doc} t={t} onDelete={() => handleDelete(doc.document_id, doc.title)} />
        ))}
